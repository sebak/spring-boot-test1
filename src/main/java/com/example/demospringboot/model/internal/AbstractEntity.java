...
public abstract class AbstractEntity {
    ...
    @Column(name = "id", updatable = false) /* i say that the name of the column is id in database
     (or it will take the default value, the java property name id) and that column can't be update */
    UUID id;
